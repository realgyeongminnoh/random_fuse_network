...
def ParseArgs():
    parser = argparse.ArgumentParser(description="Random Fuse Network - Resistor-Capacitor (using capacitor voltage for 'edgeVolt'): Ensemble Simulation")
...
def ParallelJob(seed):
    ...
    # saving execution
    failure.idxBrokenEdges = edgeListGlobal.idxMapFromEdgesDivCapToEdges[failure.idxBrokenEdgesDivCap]
