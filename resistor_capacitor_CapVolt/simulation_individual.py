...
def ParseArgs():
    parser = argparse.ArgumentParser(description="Random Fuse Network - Resistor-Capacitor (using capacitor voltage for 'edgeVolt'): Individual Simulation")
...
def Main(length, width, seed, saveEdgeVolts):
    ...
    # saving execution
    failure.idxBrokenEdges = edgeList.idxMapFromEdgesDivCapToEdges[failure.idxBrokenEdgesDivCap]
